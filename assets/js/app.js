...
<a class="navbar-brand" href="index.html">Lord Oni</a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="projects.html">Past Work</a></li>
   <li class="nav-item">
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-12">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >Roblox dev looking to make money! since it's my passion and I do it cause I like it.</p>
    </div>
